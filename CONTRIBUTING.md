...
これを表示することは、その人たちがその記事への貢献をしたことを読者に伝える意味があります。
authors や reviewers として名前を乗せることは、基本的には authors や reviewers にとって利益になりますが、記事に重大な問題があった場合などには不利益になる可能性もあることは認識しておくべきでしょう。
